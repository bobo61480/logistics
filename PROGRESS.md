...
- [x] TASK-004 Add D1-first reads, scheduled refresh, reconciliation status, and Sheets/cache fallback.
...
- [ ] TASK-007 Activate the production binding and migrations after the Cloudflare token has D1 access.
