...
var APPS_SCRIPT_DEPLOY_SYNC_VERSION = "2026-08-11-wms-trucking-v2";
...
var TRIGGER_PLAN = [
  ...
  { handler: "scanAndImportWmsTruckingOrdersV2", minutes: 15 },// exact-date WMS trucking scanner with Aug-2026 cutoff
